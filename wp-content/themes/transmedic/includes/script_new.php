  ...
  <?php if ($is_debug == true): ?>
    ...
    <script type="text/javascript">
      goog.require('transmedic.page.New');
    </script>
  ...
  <?php else: ?>
    ...
    <script type="text/javascript">
      ...
      var PAGE_LIBRARY        = "<?php echo JS; ?>/minified/libraries-new.min.js";
      var PAGE_JS             = "<?php echo JS; ?>/minified/page-new.min.js";
      ...
      window.head_js.load(PAGE_LIBRARY, function() {
        window.head_js.load(PAGE_JS, function() {
          window.page = new transmedic.page.New({});
        });
      });
    </script>
