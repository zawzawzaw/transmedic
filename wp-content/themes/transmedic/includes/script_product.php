  ...
  <?php if ($is_debug == true): ?>
    ...
    <!-- odometer animation -->
    <script type="text/javascript" src="<?php echo LIBS; ?>/odometer/odometer.min.js"></script>
    ...
    <script type="text/javascript">
      goog.require('transmedic.page.Product');
    </script>
    ...
    <script type="text/javascript">
      ...
      jQuery(document).ready(function($) {
        page = new transmedic.page.Product({});
      });
  ...
  <?php else: ?>
    ...
    <script type="text/javascript">
      ...
      var PAGE_LIBRARY        = "<?php echo JS; ?>/minified/libraries-product.min.js";
      var PAGE_JS             = "<?php echo JS; ?>/minified/page-product.min.js";
      ...
      window.head_js.load(PAGE_LIBRARY, function() {
        window.head_js.load(PAGE_JS, function() {
          window.page = new transmedic.page.Product({});
        });
      });
    </script>
