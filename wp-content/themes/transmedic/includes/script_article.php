  ...
  <link href="https://fonts.googleapis.com/css?family=Merriweather:700,400|Source+Sans+Pro:300,300i,400,600,700" rel="stylesheet">
  ...
  <?php if ($is_debug == true): ?>
    ...
    <script type="text/javascript">
      goog.require('transmedic.page.Article');
    </script>
    ...
    <script type="text/javascript">
      ...
      jQuery(document).ready(function($) {
        page = new transmedic.page.Article({});
      });
  ...
  <?php else: ?>
    ...
    <script type="text/javascript">
      ...
      var PAGE_LIBRARY        = "<?php echo JS; ?>/minified/libraries-article.min.js";
      var PAGE_JS             = "<?php echo JS; ?>/minified/page-article.min.js";
      ...
      window.head_js.load(PAGE_LIBRARY, function() {
        window.head_js.load(PAGE_JS, function() {
          window.page = new transmedic.page.Article({});
        });
      });
    </script>
